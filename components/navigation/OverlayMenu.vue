    ...
    <div class="nav-content">
      <div class="grid-container">
        ...
        <router-link
          ...
          @click="$emit('close')"
        >
          <UIcon name="i-lucide-house" class="main-icon" />
          <span>Giriş</span>
        </router-link>
        ...
        <router-link
          ...
          @click="$emit('close')"
        >
          <UIcon name="i-lucide-code-2" class="main-icon" />
          <span>Projeler</span>
        </router-link>
        ...
        <router-link
          ...
          @click="$emit('close')"
        >
          <UIcon name="i-lucide-zap" class="main-icon" />
        ...
        >
          <div class="contact-inner">
            <UIcon name="i-lucide-mail" class="main-icon" />
            <span>İletişim</span>
          </div>
        </router-link>
      </div>
