          ...
          <div class="card-content">
            ...
            <div class="card-actions">
              <a :href="repo.html_url" target="_blank" class="action-btn primary" title="GitHub'da Görüntüle">
                <UIcon name="i-ph-github-logo-bold" class="w-6 h-6" />
                <span>Source</span>
              </a>
              <a
                v-if="repo.homepage"
              ...
              >
                <UIcon name="i-ph-arrow-up-right-bold" class="w-6 h-6" />
                <span>Live</span>
              </a>
            </div>
            ...
            <div class="card-footer">
              ...
              <span class="stars">
                <UIcon name="i-ph-star-fill" class="w-4 h-4" /> {{ repo.stargazers_count }}
              </span>
            </div>
          </div>
        </div>
