          ...
          <div class="social-list">
            <div v-for="social in socials" :key="social.label" class="social-card">
              <a :href="social.url" target="_blank">
                <UIcon :name="social.icon" class="contact-icon" />
              ...
              >
                <UIcon :name="copied === social.value ? 'i-ph-check-bold' : 'i-ph-copy-bold'" class="w-6 h-6" />
              </button>
            </div>
          </div>
        </div>
        ...
        <div class="contact-form-container">
          ...
          >
            ...
            <button type="submit" class="submit-btn">
              <span>Gönder</span>
              <UIcon name="i-ph-paper-plane-tilt-bold" class="w-5 h-5" />
            </button>
          </form>
        </div>
      </div>
